  ...
  return (
    <div className="container-x py-16">
      ...
      <p className="text-gray-600 max-w-2xl">
        ...
        years. We specialize in residential, commercial, rental, resale, villas, apartments, PGs and land deals,
        backed by transparent pricing and end-to-end legal and loan support.
      </p>
    </div>
  );
}